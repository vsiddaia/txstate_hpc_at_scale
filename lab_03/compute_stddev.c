...
int main(int argc, char** argv) {
  ...
  // calculate the mean. Hint: Use MPI_Allreduce to implement it. Can you use MPI_Reduce? Why or why not?

  // Compute the local sum of the squared differences from the mean

  // Reduce the global sum of the squared differences to the root process
  // and print off the answer. Hint: Use MPI_Reduce to implement this functionality. Can you use MPI_Allreduce? Why or why not?
